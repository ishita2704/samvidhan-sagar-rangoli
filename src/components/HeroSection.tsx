...
Trouble understanding the constituition? We've got a fun and easy way to learn!</p>
        ...
        <ScrollAnimation animationClass="animate-fade-in" delay={600}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" className="bg-white/10 backdrop-blur border-white/30 text-white hover:bg-white/20 text-lg">Explore Resources
          </Button>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animationClass="animate-fade-in" delay={900}>
          <div className="mt-16 flex justify-center">
            <div className="animate-bounce">
              <a href="#features" className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/20 backdrop-blur hover:bg-white/30 transition-colors">
