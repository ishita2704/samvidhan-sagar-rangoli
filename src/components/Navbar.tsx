  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-cream/95 backdrop-blur shadow-md py-2"
    ...
    >
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <div className="hidden md:flex items-center gap-6">
          <a
            href="#home"
            className="font-medium text-white hover:text-terracotta transition-colors"
          >
            Home
          </a>
          <a
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-full left-0 w-full bg-cream shadow-md transition-all duration-300 overflow-hidden ${
